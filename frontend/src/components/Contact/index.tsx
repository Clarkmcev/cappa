...
function Contact() {
  ...
  return (
    <section
      ref={scope}
      className="p-5 flex space-y-4 flex-col font-custom m-20 xl:m-44 pb-20"
    >
      ...
      <div className="text-primary">
        <div className="opacity-0 text-primary text-lg">
          ...
          event, or simply sharing thoughts on painting, Amanda would love to
          hear from you. Fill out the form below, and she will get back to you
          as soon as possible.
        </div>
      </div>
      <ContactForm />
